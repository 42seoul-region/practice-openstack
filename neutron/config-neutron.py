...
config['DEFAULT']['transport_url'] = 'rabbit://openstack:{RABBIT_PASS}@{HOST_INTERNAL_RABBITMQ}:5672/'.format(**os.environ)
...
config['keystone_authtoken']['memcached_servers'] = '{HOST_INTERNAL_MEMCACHED}:11211'.format(**os.environ)
