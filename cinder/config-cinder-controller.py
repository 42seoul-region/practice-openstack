...
# [database]
conf_cinder['database']['connection'] = 'mysql+pymysql://{CINDER_DATABASE_USER}:{CINDER_DATABASE_PASSWORD}@{CINDER_DATABASE_HOST}:{CINDER_DATABASE_PORT}/{CINDER_DATABASE_SCHEME}'.format(**os.environ)
...
# [keystone_authtoken]
if 'keystone_authtoken' not in conf_cinder:
...
conf_cinder['keystone_authtoken']['password'] = os.environ['CINDER_PASSWORD']

# [oslo_concurrency]
if 'oslo_concurrency' not in conf_cinder:
    conf_cinder['oslo_concurrency'] = {}
