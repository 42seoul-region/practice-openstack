...
CREATE DATABASE \`$NEUTRON_DATABASE_SCHEME\`;
CREATE DATABASE \`$CINDER_DATABASE_SCHEME\`;
...
CREATE USER '$NEUTRON_DATABASE_USER'@'%' IDENTIFIED BY '$NEUTRON_DATABASE_PASSWORD';
CREATE USER '$CINDER_DATABASE_USER'@'%' IDENTIFIED BY '$CINDER_DATABASE_PASSWORD';
...
GRANT ALL PRIVILEGES ON \`$NEUTRON_DATABASE_SCHEME\`.* TO '$NEUTRON_DATABASE_USER'@'%';
GRANT ALL PRIVILEGES ON \`$CINDER_DATABASE_SCHEME\`.* TO '$CINDER_DATABASE_USER'@'%';
